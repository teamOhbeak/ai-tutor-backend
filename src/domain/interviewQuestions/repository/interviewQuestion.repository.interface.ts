...
} from "../entity/interviewQuestions.entity";
import {
  InterviewQuestionsRepository
} from "./interviewQuestions.repository.";
import {
  Inject,
  Injectable
} from "@nestjs/common";
...
extends Repository < InterviewQuestionsEntity >
  implements InterviewQuestionsRepository {
    ...
    async getQuestions(questionId: number, stack: string): Promise < InterviewQuestionsEntity[] > {
      console.log('레포지토리')
      try {

...
} from '@/interface/interview/response/my-interview-detail.response';
import {
  MyInterviewResponse
} from '@/interface/interview/response/my-interview.response';
import {
  IInterviewService
} from './interview.service.interface';
import {
  CreateInterviewRequest
} from '@/interface/interview/request/create-interview.request';
import {
  InterviewRepository
} from '../repository/interview.repository.interface';
import {
  Inject,
  Injectable
} from '@nestjs/common';
...
export class InterviewService implements IInterviewService {
  ...
  public async createInterview(
    ...
    const response = await this.openAi.aiTutorPrompt(requestModel.stack, requestModel.questionCount)
